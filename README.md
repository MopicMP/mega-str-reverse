...
> Mega reverse strings with unicode support

[![PyPI version](https://badge.fury.io/py/mega-str-reverse.svg)](https://pypi.org/project/mega-str-reverse/)
...
# Basic usage
result = reverse("your input here")
print(result)
```
...
from mega_str_reverse import batch
